...
public class Report {
    ...
    public static void beforeClass() {
        ...
        ExtentHtmlReporter htmlReporter = new ExtentHtmlReporter("C:\\Users\\motin\\Dropbox\\QA EXPERTS\\Automation\\Final Project\\MyProject\\BuyMe.html");
        ...
        extent.setSystemInfo("Natalia", "Gift");
        ...
        try {
            System.setProperty("webdriver.chrome.driver", "C:\\Users\\motin\\Downloads\\chromedriver_win32\\chromedriver.exe");
    ...
    public void test2_clickButton() throws IOException {
        ...
        test.pass("details", MediaEntityBuilder.createScreenCaptureFromPath(takeScreenShot("C:\\Users\\motin\\Pictures\\Automation\\ScreenShots\\" + currentTime)).build());
